...
class BoxList(object):
    ...
    def extend(self, scale):
        ...
        extended_box = torch.cat((extended_xmin, extended_ymin, extended_xmax, extended_ymax), dim=-1)
    ...
    def random_aug(self, jitter_x_out, jitter_x_in, jitter_y_out, jitter_y_in):
        ...
        aug_box = torch.cat((jitter_xmin, jitter_ymin, jitter_xmax, jitter_ymax), dim=-1)
